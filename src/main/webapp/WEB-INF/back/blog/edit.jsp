...
<form action="/back/postUpdate.do" id="myform">
    <!-- 作者姓名，作者账户 -->
    ...
    <div class="formbody">
        ...
        <div id="usual1" class="usual">
            ...
            <ul class="forminfo">
                ...
                <li><label>文章题目<b>*</b></label><input name="blogTitle" type="text" class="dfinput" value="${Post.blogTitle}"
                                                      style="width:350px;"/></li>
                <li><label>主题<b>*</b></label><input name="standby003" type="text" class="dfinput" value="${Post.standby003}"
                                                    style="width:350px;"/></li>
                <li><label>文章推荐级别<b>*</b></label><input name="blogLevel" type="text" class="dfinput" value="${Post.blogLevel}"
                                                        style="width:350px;"/></li>
                <li>
                    <label>文章所属分类<b>*</b></label>
                    <div class="vocation">
                        <select class="dfinput" id="blogSort" name="blogSort">
                            <option value="">${Post.blogSort}</option>
                ...
                <li>
                    ...
                    <div class="vocation">
                        <select class="dfinput" id="standby002" name="standby002">
                            <option value="">${Post.standby002}</option>
