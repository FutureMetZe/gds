        ...
        <div id="tab1" class="tabson">
            ...
            <form action="/back/goodsUpdate.do">
                ...
                <ul class="forminfo">
                    ...
                    <li><label>物品名称<b>*</b></label><input name="goodsName" type="text" class="dfinput"
                                                          value="${goods.goodsName}" style="width:350px;"/></li>
                    ...
                    <li><label>备注<b></b></label><textarea name="standby001" id="" cols="90" class="textinput"
                                                          rows="10">${goods.standby001} </textarea></li>
