...
<body>
    ...
    <ul class="forminfo">
    <li><label>物品名称<b>*</b></label><input name="goodsName" type="text" class="dfinput" value=""  style="width:350px;"/></li>
    ...
    <li>
        ...
        <li><label>备注<b></b></label><textarea name="standby001" id="" cols="90" class="textinput" rows="10" ></textarea></li>
