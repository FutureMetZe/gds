...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <form action="${pageContext.request.contextPath }/back/blogList.do">
                <li><label>文章标题：</label><input name="blogTitle" type="text" class="dfinput" value="${blogAuthor}"
                                               style="width:110px;"/></li>&nbsp;&nbsp;
                <li><label>留言者：</label><input name="reviewUserName" type="text" class="dfinput" value="${blogSort}"
    ...
    <FORM id="pageForm" name="customerForm" action="${pageContext.request.contextPath }/back/postReviewList.do">
        <!-- 隐藏域.当前页码 -->
