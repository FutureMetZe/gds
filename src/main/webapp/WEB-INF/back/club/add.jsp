...
<body>
    ...
    <ul class="forminfo">
    <li><label>社团名称<b>*</b></label><input name="club_name" type="text" class="dfinput" value=""  style="width:350px;"/></li>
    ...
    <li>
        ...
        <li><label>负责人姓名<b>*</b></label><input name="club_standby001" type="text" class="dfinput" value=""  style="width:350px;"/></li>
        <li><label>负责人学号<b>*</b></label><input name="club_standby002" type="text" class="dfinput" value=""  style="width:350px;"/></li>
        <li><label>社团简介<b></b></label><textarea name="club_introduce" id="" cols="90" class="textinput" rows="10" ></textarea></li>
