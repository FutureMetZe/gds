...
<body>
    ...
    <ul class="forminfo">
    <li><label>账&nbsp;&nbsp;&nbsp;&nbsp;号<b>*</b></label><input name="username" type="text" class="dfinput" value=""  style="width:350px;"/></li>
    <li><label>密&nbsp;&nbsp;&nbsp;&nbsp;码<b>*</b></label><input name="password" type="text" class="dfinput" value=""  style="width:350px;"/></li>
    <li><label>姓&nbsp;&nbsp;&nbsp;&nbsp;名<b>*</b></label><input name="stu_name" type="text" class="dfinput" value=""  style="width:350px;"/></li>
    <li><label>学&nbsp;&nbsp;&nbsp;&nbsp;号<b>*</b></label><input name="stu_num" type="text" class="dfinput" value=""  style="width:350px;"/></li>
    ...
    <li>
        ...
        <li><label>邮&nbsp;&nbsp;&nbsp;&nbsp;箱<b></b></label><input name="email" type="text" class="dfinput" value=""  style="width:350px;"/></li>
