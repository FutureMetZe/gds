...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <form action="${pageContext.request.contextPath }/back/stuMag.do">
                <li><label>用户名：</label><input name="username" type="text" class="dfinput" value="${username}"
                                              style="width:110px;"/></li>&nbsp;&nbsp;
                <li><label>姓名：</label><input name="stu_name" type="text" class="dfinput" value="${stu_name}"
                                             style="width:110px;"/></li>&nbsp;&nbsp;
                <li><label>学院：</label><input name="standby001" type="text" class="dfinput" value="${standby001}"
        ...
        <ul class="toolbar1">
            <li onclick="forAddPage()"><span><img src="${pageContext.request.contextPath }/back/images/t01.png"/></span>新增
            </li>
        </ul>

    </div>

    <FORM id="pageForm" name="customerForm" action="${pageContext.request.contextPath }/back/stuMag.do">
        <!-- 隐藏域.当前页码 -->
        ...
        <table class="tablelist">
            ...
            <c:forEach items="${beans}" var="Student">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath }/back/stuIntroduce.do?user_id=${Student.userId}"
    ...
    <DIV style="LINE-HEIGHT: 40px; HEIGHT: 40px; TEXT-ALIGN: right">
        ...
        ；每页显示
        <select name="pageSize" onchange="changePageSize(jQuery('#pageSizeSelect option:selected').val())"
                id="pageSizeSelect">
            <option value="5"
