                ...
                <div class="am-fl am-cf">
                    <div class="am-btn-toolbar am-fl">
                        <div class="am-btn-group am-btn-group-xs">
                            <button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> <a href="/assets/admin-user.do" >发布新公告</a>
                            </button>
                ...
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <th class="table-author">公告标题</th>
                            <th class="table-author">置顶级别</th>
                        ...
                        <c:forEach items="${notices}" var="Notice">
                            <tr>
                                ...
                                <td>${Notice.noticeClubName}</td>
                                <td>${Notice.standby001}</td>
                                <td>${Notice.noticeState}</td>
                                <td>${Notice.noticeContent}</td>

                                <td>${Notice.noticeCreatTime}</td>
                                <td>
