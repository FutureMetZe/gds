...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">发布新公告</strong> / <small>Make new announcement</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="/assets/saveNotice.do">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-name" placeholder="活动主题" name="standby001">
              <small>输入活动主题。</small>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="user-intro" placeholder="输入公告内容" name="noticeContent"></textarea>
              <small>请控制在250字以内写出公告详情...</small>
            </div>
          </div>
