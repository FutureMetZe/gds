...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">物资</strong> /
                <small>管理</small>
            </div>
        </div>
                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <c:forEach items="${goods}" var="Good">
                            <tr>
                                ...
                                <td>${Good.goodsDepartment}</td>

                                <td>${Good.standby001}</td>

                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                    class="am-icon-pencil-square-o"></span> <a href="/assets/returnGoods.do?goodId=${Good.goodsId}" onClick="return confirm('确定归还操作?');"
                                            >归还</a>
                                            </button>
